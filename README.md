...
npx --yes github:aimaoge/timem-dsh-mcp --verify --key sk-xxxx --user-id usr_xxx
```
...
> - PowerShell：`$env:npm_config_strict_ssl='false'; npx --yes github:aimaoge/timem-dsh-mcp`
> - bash/zsh：`npm_config_strict_ssl=false npx --yes github:aimaoge/timem-dsh-mcp`
...
- 当前版本：**v0.2.0**，查看：`npx --yes github:aimaoge/timem-dsh-mcp --version`
- 固定版本（可复现）：`npx --yes github:aimaoge/timem-dsh-mcp#v0.2.0`
